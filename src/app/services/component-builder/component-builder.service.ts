...
import { CrSelectCompanyComponent } from 'src/app/modules/widget-app/cr-select-company/cr-select-company.component';
import { SelectCompanyConfigModel, SelectCompanyDataModel } from 'src/app/modules/widget-app/cr-select-company/cr-select-company.model';
import { CompanyRejectComponent } from 'src/app/modules/widget-app/company/company-reject/company-reject.component';
import { CompanyRejectDataModel, CompanyRejectConfigModel } from 'src/app/modules/widget-app/company/company-reject/company-reject.model';
import { CaseAssignFcFormComponent } from 'src/app/modules/widget-app/case/case-assign-fc-form/case-assign-fc-form.component';
import { CaseAssignFCDataModel, CaseAssignFCConfigModel } from 'src/app/modules/widget-app/case/case-assign-fc-form/case-assign-fc-form.model';
import { CaseApproveBasicInfoComponent } from 'src/app/modules/widget-app/case-approve-basic-info/case-approve-basic-info.component';
import { CaseApproveBasicConfigModel, CaseApproveBasicInfoDataModel } from 'src/app/modules/widget-app/case-approve-basic-info/case-approve-basic-info-model';
import { CaseApproveEditCaseComponent } from 'src/app/modules/widget-app/case-approve-edit-case/case-approve-edit-case.component';
import { CaseApproveEditCaseConfigModel, CaseApproveEditCaseDataModel } from 'src/app/modules/widget-app/case-approve-edit-case/case-approve-edit-case-model';
import { AddCaseRemarkFormComponent } from 'src/app/modules/widget-app/case-remark/add-case-remark-form/add-case-remark-form.component';
import { AddCaseRemarkDataModel, AddCaseRemarkConfigModel } from 'src/app/modules/widget-app/case-remark/add-case-remark-form/add-case-remark-form.model';
import { MatTabA2ConfigModel, MatTabA2Model } from 'src/app/modules/widget-app/mat-tab-a2/mat-tab-a2-model';
import { MatTabA2Component } from 'src/app/modules/widget-app/mat-tab-a2/mat-tab-a2.component';
import { CvAllocateDeptComponent } from 'src/app/modules/widget-app/case/cv-allocate-dept/cv-allocate-dept.component';
import { AllocateDeptDataModel, AllocateDeptConfigModel } from 'src/app/modules/widget-app/case/cv-allocate-dept/cv-allocate-dept.model';
import { QuotationInvoiceUploadComponent } from 'src/app/modules/widget-app/quotation-invoice-upload/quotation-invoice-upload.component';
import { QuotationInvoiceUploadDataModel, QuotationInvoiceUploadConfigModel } from 'src/app/modules/widget-app/quotation-invoice-upload/quotation-invoice-upload.model';
import { RequestNotesFormComponent } from 'src/app/modules/widget-app/request-notes-form/request-notes-form.component';
import { RequestNotesFormConfigModel, RequestNotesFormDataModel } from 'src/app/modules/widget-app/request-notes-form/request-notes-form-model';
import { RequestNotesForm2ConfigModel, RequestNotesForm2DataModel } from 'src/app/modules/widget-app/request-notes-form2/request-notes-form2-model';
import { RequestNotesForm2Component } from 'src/app/modules/widget-app/request-notes-form2/request-notes-form2.component';
import { ClearanceNoteFormComponent } from 'src/app/modules/widget-app/clearance-note/clearance-note-form/clearance-note-form.component';
import { ClearanceNoteFormConfigModel, ClearanceNoteFormDataModel } from 'src/app/modules/widget-app/clearance-note/clearance-note-form/clearance-note-form-model';
import { ClearanceNoteTableComponent } from 'src/app/modules/widget-app/clearance-note/clearance-note-table/clearance-note-table.component';
import { ClearanceNoteTableConfigModel, ClearanceNoteTableDataModel } from 'src/app/modules/widget-app/clearance-note/clearance-note-table/clearance-note-table-model';
import { ClearanceNoteDropdownComponent } from 'src/app/modules/widget-app/clearance-note/clearance-note-dropdown/clearance-note-dropdown.component';
import { ClearanceNoteDropdownConfigModel, ClearanceNoteDropdownDataModel } from 'src/app/modules/widget-app/clearance-note/clearance-note-dropdown/clearance-note-dropdown-model';
import { ReportsFilterComponent } from 'src/app/modules/widget-app/case/reports/reports-filter/reports-filter.component';
import { ReportsFilterDataModel, ReportsFilterConfigModel } from 'src/app/modules/widget-app/case/reports/reports-filter/reports-filter.model';
import { ReportsUploadComponent } from 'src/app/modules/widget-app/case/reports/reports-upload/reports-upload.component';
import { ReportsUploadDataModel, ReportsUploadConfigModel } from 'src/app/modules/widget-app/case/reports/reports-upload/reports-upload.model';
import { CaseRegBtnConfigModel, CaseRegBtnDataModel } from 'src/app/modules/widget-app/custom-btn/case-reg-btn/case-reg-btn-model';
import { CaseRegBtnComponent } from 'src/app/modules/widget-app/custom-btn/case-reg-btn/case-reg-btn.component';
import { EngineersFilterComponent } from 'src/app/modules/widget-app/case-engineers/engineers-filter/engineers-filter.component';
import { EngineersFilterConfigModel, EngineersFilterDataModel } from 'src/app/modules/widget-app/case-engineers/engineers-filter/engineers-filter.model';
import { CaseActionButtonsConfigModel, CaseActionButtonsModel } from 'src/app/modules/widget-app/case/case-action-buttons/case-action-buttons-model';
import { CaseActionButtonsComponent } from 'src/app/modules/widget-app/case/case-action-buttons/case-action-buttons.component';
import { SelectTaggingComponent } from 'src/app/modules/widget-app/select-tagging/select-tagging.component';
import { SelectTaggingConfigModel, SelectTaggingDataModel } from 'src/app/modules/widget-app/select-tagging/select-tagging-model';
import { TaggingFormComponent } from 'src/app/modules/widget-app/tagging-form/tagging-form.component';
import { TaggingFormConfigModel, TaggingFormDataModel } from 'src/app/modules/widget-app/tagging-form/tagging-form-model';
import { CvDeptScheduleComponent } from 'src/app/modules/widget-app/case/cv-dept-schedule/cv-dept-schedule.component';
import { CvDeptScheduleDataModel, CvDeptScheduleConfigModel } from 'src/app/modules/widget-app/case/cv-dept-schedule/cv-dept-schedule.model';
import { ClearanceFilterComponent } from 'src/app/modules/widget-app/clearance-filter/clearance-filter.component';
import { ClearanceFilterConfigModel, ClearanceFilterDataModel } from 'src/app/modules/widget-app/clearance-filter/clearance-filter-model';
import { CertificateHandlerFilterComponent } from 'src/app/modules/widget-app/case/certificate-handler-filter/certificate-handler-filter.component';
import { CertificateHandlerFilterConfigModel, CertificateHandlerFilterDataModel } from 'src/app/modules/widget-app/case/certificate-handler-filter/certificate-handler-filter.model';
import { ForgotPassUsernameFormComponent } from 'src/app/modules/widget-app/forgot-password/forgot-pass-username-form/forgot-pass-username-form.component';
import { ForgotPassUsernameFormDataModel, ForgotPassUsernameFormConfigModel } from 'src/app/modules/widget-app/forgot-password/forgot-pass-username-form/forgot-pass-username-form.model';
import { MoreInfoLinkDataComponent } from 'src/app/modules/widget-app/more-info-link-data/more-info-link-data.component';
import { MoreInfoFormConfigModel, MoreInfoFormDataModel } from 'src/app/modules/widget-app/more-info-link-data/more-info-link-data-model';
import { SyncInfoComponent } from 'src/app/modules/widget-app/sync-info/sync-info.component';
import { SyncInfoConfigModel, SyncInfoDataModel } from 'src/app/modules/widget-app/sync-info/sync-info-model';
import { DocumentTableA2ConfigModel, DocumentTableA2DataModel } from 'src/app/modules/widget-app/case-docs/document-table-a2/document-table-a2.model';
import { DocumentTableA2Component } from 'src/app/modules/widget-app/case-docs/document-table-a2/document-table-a2.component';
import { NewTabCaseFilterComponent } from 'src/app/modules/widget-app/case/new-tab-case-filter/new-tab-case-filter.component';
import { NewCaseTabFilterConfigModel, NewCaseTabFilterDataModel } from 'src/app/modules/widget-app/case/new-tab-case-filter/new-tab-case-filter-model';
import { AddBtnCompRegDocUploadComponent } from 'src/app/modules/widget-app/add-btn-comp-reg-doc-upload/add-btn-comp-reg-doc-upload.component';
import { AddBtnCompRegDocUploadConfigModel, AddBtnCompRegDocUploadDataModel } from 'src/app/modules/widget-app/add-btn-comp-reg-doc-upload/add-btn-comp-reg-doc-upload-model';
import { CspSearchComponent } from 'src/app/modules/widget-app/csp/csp-search/csp-search/csp-search.component';
import { CSPSearchConfigModel, CSPSearchDataModel } from 'src/app/modules/widget-app/csp/csp-search/csp-search/csp-search.model';
import { CSPInfoConfigModel, CSPInfoDataModel } from 'src/app/modules/widget-app/csp/csp-info/csp-info-model';
import { CspInfoComponent } from 'src/app/modules/widget-app/csp/csp-info/csp-info.component';
import { AddBtnAddEngineerComponent } from 'src/app/modules/widget-app/add-btn-add-engineer/add-btn-add-engineer.component';
import { AddBtnAddEngineerConfigModel, AddBtnAddEngineerDataModel } from 'src/app/modules/widget-app/add-btn-add-engineer/add-btn-add-engineer-model';
import { ShortCloseRemarkComponent } from 'src/app/modules/widget-app/short-close-remark/short-close-remark.component';
import { ShortCloseRemarkConfigModel, ShortCloseRemarkDataModel } from 'src/app/modules/widget-app/short-close-remark/short-close-remark-model';
import { CaseShortCloseViewInfoComponent } from 'src/app/modules/widget-app/case-short-close-view-info/case-short-close-view-info.component';
import { CaseShortCloseViewInfoConfigModel, CaseShortCloseViewInfoDataModel } from 'src/app/modules/widget-app/case-short-close-view-info/case-short-close-view-info-model';
import { PieChartA3Component } from 'src/app/modules/widgets/piechart/pie-chart-a3/pie-chart-a3.component';
import { PieChartA3ConfigModel, PieChartA3Model } from 'src/app/modules/widgets/piechart/pie-chart-a3/pie-chart-a3-model';
import { CaseStatusCardGroupComponent } from 'src/app/modules/widget-app/dashboard/case-status-card-group/case-status-card-group.component';
import { CaseStatusCardGroupConfigModel, CaseStatusCardGroupDataModel } from 'src/app/modules/widget-app/dashboard/case-status-card-group/case-status-card-group.model';
import { DeptCaseCardGroupComponent } from 'src/app/modules/widget-app/dashboard/dept-case-card-group/dept-case-card-group.component';
import { DeptCaseCardGroupConfigModel, DeptCaseCardGroupDataModel } from 'src/app/modules/widget-app/dashboard/dept-case-card-group/dept-case-card-group.model';
import { CaseTypeCardGroupComponent } from 'src/app/modules/widget-app/dashboard/case-type-card-group/case-type-card-group.component';
import { CaseTypeCardGroupConfigModel, CaseTypeCardGroupDataModel } from 'src/app/modules/widget-app/dashboard/case-type-card-group/case-type-card-group.model';
import { BarChartA5ConfigModel, BarChartA5Model } from 'src/app/modules/widgets/barchart/bar-chart-a5/bar-chart-a5-model';
import { BarChartA5Component } from 'src/app/modules/widgets/barchart/bar-chart-a5/bar-chart-a5.component';
import { FinanceCardComponent } from 'src/app/modules/widget-app/dashboard/finance-card/finance-card.component';
import { FinanceCardConfigModel, FinanceCardDataModel } from 'src/app/modules/widget-app/dashboard/finance-card/finance-card.model';
import { DashChartFilterA1ConfigModel, DashChartFilterA1DataModel } from 'src/app/modules/widget-app/dash-chart-filter-a1/dash-chart-filter-a1-model';
import { DashChartFilterA1Component } from 'src/app/modules/widget-app/dash-chart-filter-a1/dash-chart-filter-a1.component';
import { TableActionBtnDataModel, TableActionBtnConfigModel } from 'src/app/modules/widget-app/table-action-btn/table-action-btn.model';
import { TableActionBtnComponent } from 'src/app/modules/widget-app/table-action-btn/table-action-btn.component';
import { CaseStatusCardGroupA2ConfigModel, CaseStatusCardGroupA2DataModel } from 'src/app/modules/widget-app/dashboard/case-status-card-group-a2/case-status-card-group-a2.model';
import { CaseStatusCardGroupA2Component } from 'src/app/modules/widget-app/dashboard/case-status-card-group-a2/case-status-card-group-a2.component';
import { AccordionA1ConfigModel, AccordionA1Model } from 'src/app/modules/widgets/accordion-a1/accordion.model';
import { AccordionA1Component } from 'src/app/modules/widgets/accordion-a1/accordion-a1.component';
import { CaseStatusCardGroupA3ConfigModel, CaseStatusCardGroupA3DataModel } from 'src/app/modules/widget-app/dashboard/case-status-card-group-a3/case-status-card-group.model';
import { CaseStatusCardGroupA3Component } from 'src/app/modules/widget-app/dashboard/case-status-card-group-a3/case-status-card-group-a3.component';
import { LineChartDropdownA1Component } from 'src/app/modules/widget-app/dash-chart-dropdown/line-chart-dropdown-a1/line-chart-dropdown-a1.component';
import { LineChartDropdownA1ConfigModel, LineChartDropdownA1DataModel } from 'src/app/modules/widget-app/dash-chart-dropdown/line-chart-dropdown-a1/line-chart-dropdown-a1-model';
import { LineChartDropdownA2Component } from 'src/app/modules/widget-app/dash-chart-dropdown/line-chart-dropdown-a2/line-chart-dropdown-a2.component';
import { LineChartDropdownA2ConfigModel, LineChartDropdownA2DataModel } from 'src/app/modules/widget-app/dash-chart-dropdown/line-chart-dropdown-a2/line-chart-dropdown-a2-model';
import { BarChartDropdownA1Component } from 'src/app/modules/widget-app/dash-chart-dropdown/bar-chart-dropdown-a1/bar-chart-dropdown-a1.component';
import { BarChartDropdownA1ConfigModel, BarChartDropdownA1DataModel } from 'src/app/modules/widget-app/dash-chart-dropdown/bar-chart-dropdown-a1/bar-chart-dropdown-a1-model';
...
import { StackedBarChartA1ConfigModel, StackedBarChartA1Model } from 'src/app/modules/widgets/barchart/stacked-bar-chart-a1/stacked-bar-chart-a1-model';
import { DispatchSearchComponent } from 'src/app/modules/widget-app/dispatch-register/dispatch-search/dispatch-search.component';
import { DispatchSearchConfigModel, DispatchSearchDataModel } from 'src/app/modules/widget-app/dispatch-register/dispatch-search/dispatch-search.model';
import { DispatchInfoComponent } from 'src/app/modules/widget-app/dispatch-register/dispatch-info/dispatch-info.component';
import { DispatchInfoDataModel, DispatchInfoConfigModel } from 'src/app/modules/widget-app/dispatch-register/dispatch-info/dispatch-info.model';
import { AddDispatchFormComponent } from 'src/app/modules/widget-app/dispatch-register/add-dispatch-form/add-dispatch-form.component';
import { AddDespFormConfigModel, AddDespFormDataModel } from 'src/app/modules/widget-app/dispatch-register/add-dispatch-form/add-dispatch-form.model';
import { CaseTestStopConfigModel, CaseTestStopDataModel } from 'src/app/modules/widget-app/case/case-test-stop-form/case-test-stop-form.model';
import { CaseTestStopFormComponent } from 'src/app/modules/widget-app/case/case-test-stop-form/case-test-stop-form.component';
import { QueryViewInfoComponent } from 'src/app/modules/widget-app/query-view-info/query-view-info.component';
import { QueryViewInfoDataModel, QueryViewInfoConfigModel } from 'src/app/modules/widget-app/query-view-info/query-view-info-model';
import { QueryReplyComponent } from 'src/app/modules/widget-app/case-query/query-reply/query-reply.component';
import { QueryReplyConfigModel, QueryReplyDataModel } from 'src/app/modules/widget-app/case-query/query-reply/query-reply-model';
import { QueryResponseInfoComponent } from 'src/app/modules/widget-app/query-response-info/query-response-info.component';
import { QueryResponseInfoConfigModel, QueryResponseInfoDataModel } from 'src/app/modules/widget-app/query-response-info/query-response-info-model';
import { RequestNoteActionBtnsComponent } from 'src/app/modules/widget-app/request-note-action-btns/request-note-action-btns.component';
import { RequestNoteActionBtnsConfigModel, RequestNoteActionBtnsModel } from 'src/app/modules/widget-app/request-note-action-btns/request-note-action-btns-model';
import { TagFilterConfigModel, TagFilterDataModel } from 'src/app/modules/widget-app/tag-filter/tag-filter.model';
import { TagFilterComponent } from 'src/app/modules/widget-app/tag-filter/tag-filter.component';
import { MisReportFilterComponent } from 'src/app/modules/widget-app/mis-reports/mis-report-filter/mis-report-filter.component';
import { MISReportsFilterConfigModel, MISReportsFilterDataModel } from 'src/app/modules/widget-app/mis-reports/mis-report-filter/mis-report-filter.model';
import { DynamicTableComponent } from 'src/app/modules/widget-app/data-input/dynamic-table/dynamic-table.component';
import { DynamicTableDataConfigModel, DynamicTableDataModel } from 'src/app/modules/widget-app/data-input/dynamic-table/dynamic-table.model';
import { MisReportDetailsComponent } from 'src/app/modules/widget-app/mis-reports/mis-report-details/mis-report-details.component';
import { MISReportsDetailsConfigModel, MISReportsDetailsDataModel } from 'src/app/modules/widget-app/mis-reports/mis-report-details/mis-report-details.model';
import { MisReportActionButtonComponent } from 'src/app/modules/widget-app/mis-reports/mis-report-action-button/mis-report-action-button.component';
import { MISReportsActionButtonConfigModel, MISReportsActionButtonModel } from 'src/app/modules/widget-app/mis-reports/mis-report-action-button/mis-report-action-button.model';
import { DynamicFilterComponent } from 'src/app/modules/widgets/dynamic-filter/dynamic-filter.component';
import { DynamicFilterConfigModel, DynamicFilterDataModel } from 'src/app/modules/widgets/dynamic-filter/dynamic-filter-model';
import { CvChechklistDataModel, CvChecklistConfigModel } from 'src/app/modules/request-data/case-registration/cv-case-checklist/cv-case-checklist.model';
import { CvCaseChecklistComponent } from 'src/app/modules/request-data/case-registration/cv-case-checklist/cv-case-checklist.component';
import { CvTable8Table9Component } from 'src/app/modules/widget-app/cv-table8-table9/cv-table8-table9.component';
import { CvTable8Table9ConfigModel, CvTable8Table9DataModel } from 'src/app/modules/widget-app/cv-table8-table9/cv-table8-table9.model';
import { DocumentViewerComponent } from 'src/app/modules/widgets/document-viewer/document-viewer.component';
import { DocumentViewerDataModel, DocumentViewerConfigModel } from 'src/app/modules/widgets/document-viewer/document-viewer.model';
import { MyCaseTabFilterComponent } from 'src/app/modules/widget-app/case/my-case-tab-filter/my-case-tab-filter.component';
import { MyCaseTabFilterConfigModel, MyCaseTabFilterDataModel } from 'src/app/modules/widget-app/case/my-case-tab-filter/my-case-tab-filter.model';
